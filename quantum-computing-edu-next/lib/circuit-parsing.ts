...
const parseGate = (
  ...
  const gate_base_obj = {
    ...
    parameters: (gate_data.parameters !== undefined
...
const parseCircuit = (
  ...
  operations: circuit_data.operations.map(operation_data => {
    const operation_base_obj = {
      ...
      controls:
        operation_data.controls === undefined ? [] : operation_data.controls,
      anticontrols:
        operation_data.anticontrols === undefined
          ? []
          : operation_data.anticontrols,
      inverse:
        operation_data.inverse === undefined ? false : operation_data.inverse,
      exponent:
        operation_data.exponent === undefined ? 1 : operation_data.exponent,
      parameter_values: (operation_data.parameter_values === undefined
        ? []
        : operation_data.parameter_values) as OperationParameterValue[],
    };
